// $Id: Preferences.m,v 1.162 2008-10-02 03:48:36 yfabian Exp $
/*
 **  Preferences.m
 **
...
{
	if(shared == nil)
		[NSBundle loadNibNamed:@"Preferences" owner:[Preferences class]];
	NSParameterAssert(shared != nil);
	return shared;
}


// Static method to copy old prefs: iTerm.plist => net.sourceforge.iTerm.plist
+ (void)migratePreferences
{
	...
	if(([mgr fileExistsAtPath:oldPrefs]) && (![mgr fileExistsAtPath:newPrefs])) {
...
- (id)awakeFromNib
{
	...
	[prefs setObject:[infoDict objectForKey:@"CFBundleVersion"] forKey:@"iTerm Version"];

	[[NSNotificationCenter defaultCenter] addObserver:self
		selector:@selector(_reloadURLHandlers:) name:@"iTermReloadAddressBook"
		object:nil];
}
